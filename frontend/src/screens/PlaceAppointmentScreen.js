...
export default function PlaceAppointmentScreen() {
  ...
  const placeOrderHandler = async () => {
    try {
      ...
      navigate(`/appointment/${data.order._id}`);
    } catch (err) {
  ...
  return (
    <div>
      ...
      <h1 className="my-3">Preview Appointment</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Tax</Col>
                    <Col>{cart.taxPrice.toFixed(2)} TK</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
