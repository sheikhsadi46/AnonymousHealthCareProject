  ...
  return (
    <>
      {/* === hero section === */}
        ...
        <section className="hero__section pt-[6px] 2xl:h-[800px]">
          <div className="container">
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              ...
              <div>
                <div className="lg:w-[570px]">
                  <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                    We help patients live a healthy, longer life. Anonymously
                  </h1>
                  ...
                  <button className="btn11">Request an Appointment</button>
                  </Link>
              ...
              <div className='flex gap-[30px] justify-end'>
                  <div>
                    <img className='section' src={heroImg01} alt=''/>
                  </div>
        ...
        <section>
          <div className='container'>
            ...
            <div className='flex flex-wrap items-cener flex-col md:flex-row gap-5lg:gap-[30px] mt-[30px]'></div>
          </div>
        </section>
